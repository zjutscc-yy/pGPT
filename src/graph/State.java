...
import scheduler_GPG.Linearisation;
...
public class State {
    ...
    private State(BeliefBase beliefs, ArrayList<TreeNode> intentions,
    ...
    //scc_rewrite constructor
    public State(BeliefBase beliefs, ArrayList<TreeNode> intentions, HashMap<String, TreeNode> nodeLib, HashMap<String, String> preqMap, HashMap<String, String> parentMap, int playerTurn)
    {
        this(beliefs, intentions, nodeLib, preqMap, parentMap, playerTurn, 0, false, new HashSet<String>(), new HashSet<String>(), new HashSet<TreeNode>(), new HashSet<String>(), null);
    ...
    public State clone()
    {
        return new State(beliefs.clone(), new ArrayList<TreeNode>(intentions),
